...
%\citep[e.g., ][]{Vogelsberger2014Nature, Schaye2015, SomervilleDave2015}. 
%\citep[e.g., ][]{Vogelsberger2014Nature, Schaye2015, SomervilleDave2015, Dave2017}. 
...
success of the SDSS was due to it having 1,000,000 objects {\it with
very high signal-to-noise photometry and spectra}, enabling
multivariate analysis that is required for galaxy astrophysics
investigations.  {\it We desire the sample size and revolutionary
understanding with the new temporal dimension of the quasar population
across all redshifts, as the SDSS had with the low-redshift $z\sim0.1$
galaxy population.}  Our proposal takes quasar astrophysics into the
2020s, going from single objects samples, to surveys and samples of
millions of objects, with massive spectroscopic monitoring giving
access to the time-domain and leveraging these very large scale next
...
would help attract the best personel for the PDRAs, who would be
...
demographics. 
%This is linked to, but different from, WP4 in that these investigations wont necessarily be tied to the time-domain aspect of our catalogue, but will be the crucial baseline that we, and other researchers in general, will use to compare to the time-dependent discoveries. 
