...
\usepackage{graphicx, wrapfig, sidecap, multicol}
\usepackage{fancyhdr, hyperref, amssymb}
\usepackage[usenames,dvipsnames,svgnames,table]{xcolor}
\usepackage[T1]{fontenc}
\setlength {\textwidth}{180mm} 
\setlength {\textheight}{248mm}

\topmargin=-22.00mm                         %% can go up to -30.0mm
\oddsidemargin=-12.00mm
\pagestyle{fancy}
...
%\rhead{Part B1.a}
\setcounter{page}{1}
\lfoot{{\it Nicholas P. Ross}}
\rfoot{{\it Dartmouth College}}
\cfoot{{\it Page \thepage\ of 4}}

\begin{document}

\begin{center}
%  {\Large \bf Connecting Quasars with galaxy formation via\\}
%  {\Large \bf \textcolor{Cerulean}{Connecting Quasars with galaxy formation via}\\}
  {\Large \bf \textcolor{Cerulean}{From the Accretion Disk to Cosmological Probes:}\\}
\vspace{4pt} 
%  {\Large \bf Mid-infrared observations and Next Generation Telescopes}
  {\Large \bf \textcolor{Cerulean}{Quasars as Tools and Laboratories for 2020 Astrophysics}}
\end{center}
...
\noindent
{\it 
My research is based on using quasars as laboratories and tools for
...
cosmological probes. My goal is to connect the physics invoked here
...
we have available from the SDSS in the optical to mid-infrared imaging
from the WISE All-Sky Survey as well as new deep, wide-field data from
the Spitzer Space Telescope. I am a world expert in quasar surveys,
and am already a leading investigator for future missions including
the James Webb Space Telescope in the near-term and LSST and DESI in
the long term.
}
\noindent
\end{quotation}
