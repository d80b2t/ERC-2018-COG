...
LSST_ScienceBook}.
%The LSST will deliver a dataset so spectacularly different both in sky and time-sampling coverage that the Universe would have to be an exceptionally boring place to not have brand new astronomical objects and astrophysical phenomena waiting to be discovered.
%\smallskip \smallskip \noindent
...
%personel  e.g. Prof Andy Lawrence (AL) and Prof. Bob Mann (RGM), 
...
What are the star-formation properties of %mid-infrared 
...
1, a three year term for PDRA2 and a 4 year term for PDRA
3.  We request the resources and support for 1 PhD studentship.
...
SDSS-V and DESI. The costs here are \euro184,100 SDSS-V and
...
facilities.''  We specifically request access to these funds as it
gives our project access to telescopes and data in the North and
Southern Hemispheres (for complete coverage of the celestial sphere)
...
algorithms.  We emphasise that the science return is `exponential'
