...
final critical survey design and optimization trade-off studies are being made 
e.g. for DESI, SDSS-V and LSST over the next year or so. Having the ability to influence these decisions would be incredibly powerful for our science goals. Also, having the science teams and various collaborations know that the PI is embarking on this program would help attract the best personel for the PDRAs, who would be guaranteed ``First Light'' data and science. 
