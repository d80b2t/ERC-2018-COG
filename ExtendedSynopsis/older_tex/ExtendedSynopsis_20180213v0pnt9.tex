...
%{\it Only by having the spectral line changing look qsos. It doesnt say how to link spectroscopy to LSST which is the new bit - too much on general qso continuum variability. 
%% Shanks email!!
...
etc.  
%Our light-curve algorithms will sit on top of {\it QuasarSieve} and will trigger other telescopes to get e.g. timely spectrum or infrared data. 
...
%This will result in the discovery of light-curve trends with quasar type, new methods to measure black hole mass and the key science goal to see which quasars are ``changing-look'' objects. 
